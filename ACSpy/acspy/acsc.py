...
def setFPosition(hcomm, axis, wait = SYNCHRONOUS):
    "Setting digital position"
    pos = double()
    call_acsc(acs.acsc_SetFPosition, hcomm, axis, byref(pos), wait)

def getFPosition(hcomm, axis, FPosition, wait=SYNCHRONOUS):
    call_acsc(acs.acsc_GetFPosition, hcomm, axis, FPosition, wait)
